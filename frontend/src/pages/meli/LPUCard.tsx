            ...
            <div className="relative z-10 p-6 space-y-4">
                ...
                <div className="flex justify-between items-start">
                    <div className="flex items-center gap-3">
                        <h3 className={`font-bold text-gray-800 transition-all ${isFocused ? 'text-xl' : 'text-base'}`}>{work?.id || lpu.work_id}</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 bg-white/30 rounded-xl p-4 border border-white/40 relative group/info">
                    ...
                    <div className="space-y-1">
                        <div className="text-[9px] font-bold text-gray-500 uppercase tracking-wider mb-1">Endereço</div>
                        <p className="text-[11px] text-gray-800">{work?.address?.street}, {work?.address?.number} - {work?.address?.city}/{work?.address?.state}</p>
                    </div>
                    <div className="space-y-1 text-right">
                        <div className="text-[9px] font-bold text-gray-500 uppercase tracking-wider mb-1">Prazo LPU</div>
                        <p className="text-xs font-medium text-orange-700">{new Date(lpu.limit_date).toLocaleDateString('pt-BR', { timeZone: 'UTC' })}</p>
                    </div>
                </div>
