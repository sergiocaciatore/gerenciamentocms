...
export default function RDLogin() {
    ...
    const handleAuth = async (e: React.FormEvent) => {
        ...
        try {
            if (isSignUp) {
                // Ensure we have the data before creating the user
                // Ensure we have the data before creating the user
                // if (!finalRazaoSocial) {
                //    setError("Erro: Razão Social não identificada.");
                //    setIsLoading(false);
                //    return;
                // }
                ...
                navigate(`/rd/${userCredential.user.uid}`);
            } else {
    ...
    return (
        <div className="flex min-h-screen items-center justify-center p-4 bg-gradient-to-br from-gray-50 to-gray-200">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-purple-300/20 rounded-full blur-3xl mix-blend-multiply animate-blob"></div>
                <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-blue-300/20 rounded-full blur-3xl mix-blend-multiply animate-blob animation-delay-2000"></div>
            ...
            <div className="relative w-full max-w-4xl rounded-2xl bg-white/80 shadow-2xl backdrop-blur-xl ring-1 ring-white/50 flex flex-col md:flex-row">
                ...
                <div className="md:w-1/2 bg-gradient-to-br from-white to-gray-100 p-12 flex flex-col items-center justify-center border-b md:border-b-0 md:border-r border-gray-100 relative overflow-hidden">
                    ...
                    <div className="relative z-10 flex flex-col items-center">
                        <img
                            src="/cms.svg"
                            alt="Logo CMS"
                            className="w-40 h-auto mb-6 drop-shadow-lg transition-transform hover:scale-105 duration-500 object-contain"
                        />
                    </div>
                </div>
                ...
                <div className="md:w-1/2 p-12 flex flex-col justify-center bg-white/50">
                    ...
                    <form onSubmit={handleAuth} className="space-y-6">
                        ...
                        <div className="pt-4 space-y-4">
                            <button
                                type="submit"
                                disabled={isLoading}
                                className="w-full py-3.5 px-6 rounded-xl bg-gray-900 text-white font-medium shadow-lg shadow-gray-900/20 hover:bg-gray-800 hover:shadow-xl hover:-translate-y-0.5 transition-all active:scale-[0.98] disabled:opacity-70 disabled:cursor-not-allowed flex justify-center items-center gap-2"
                            >
                                {isLoading ? (
                                    <>
                    ...
                    <div className="mt-8 pt-6 border-t border-gray-100 flex justify-center">
                        <p className="text-xs text-center text-gray-400">
                            &copy; {new Date().getFullYear()} CMS System. Todos os direitos reservados.
                        </p>
                    </div>
                </div>
            </div>
