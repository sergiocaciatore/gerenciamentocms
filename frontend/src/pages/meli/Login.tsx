    ...
    return (
        <div className="flex min-h-screen items-center justify-center p-4 meli-animated-bg">
            <div className="relative w-full max-w-2xl overflow-hidden rounded-3xl bg-white/20 shadow-2xl backdrop-blur-xl ring-1 ring-white/30 transition-all duration-500 hover:shadow-3xl hover:bg-white/25 flex flex-row items-center h-80">
                ...
                {/* Left Side: Logo */}
                <div className="relative z-10 h-full p-6 flex items-center justify-center border-r border-white/10">
                    <svg
                ...
                <div className="flex-1 flex flex-col justify-center items-center p-8 gap-6">
                    ...
                    <button
                        ...
                        disabled={isLoading}
                        className="group relative flex w-full max-w-xs items-center justify-center gap-3 rounded-xl bg-white/90 px-6 py-3.5 text-sm font-semibold text-gray-900 shadow-lg transition-all hover:bg-white hover:scale-[1.02] active:scale-[0.98] disabled:opacity-70 disabled:cursor-not-allowed"
                    >
                        {isLoading ? (
                            <svg
