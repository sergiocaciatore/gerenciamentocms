# Padrões de Desenvolvimento e Boas Práticas (Miav2)

Este documento define as diretrizes técnicas e de estilo para garantir a qualidade, manutenibilidade e escalabilidade dos serviços. Todos os desenvolvedores devem aderir a este guia.
